...
//        ============================================================================
    ...
    public static void deleteImgPhone() {
        ...
        String adbCommand = "adb shell rm /storage/emulated/0/DCIM/CamScanner/B001.jpg"; // Replace with the actual file path
    ...
    public static void renameImgPhone() {
        String folderPath = "/storage/emulated/0/DCIM/CamScanner/.."; // Replace with the actual folder path
    ...
    public static void imgTranfer() {
            String adbCommand = "adb pull /storage/emulated/0/DCIM/CamScanner/B001.jpg D:\\Solution99";
