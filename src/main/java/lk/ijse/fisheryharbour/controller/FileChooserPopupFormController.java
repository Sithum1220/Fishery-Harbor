...
public class FileChooserPopupFormController implements Initializable {
    ...
    public ImageView btnClosePopup;
    ...
    public void btnCloseOnMouseEntered(MouseEvent mouseEvent) {
        btnClosePopup.setImage(new Image("img/PropertyHover.jpg"));

    }

    public void btnCloseOnMouseExited(MouseEvent mouseEvent) {
        btnClosePopup.setImage(new Image("img/close-btn.png"));
